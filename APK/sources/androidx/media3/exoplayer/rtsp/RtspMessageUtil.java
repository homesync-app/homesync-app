...
final class RtspMessageUtil {
    ...
    public static ImmutableList<String> serializeRequest(RtspRequest rtspRequest) {
        Preconditions.checkArgument(rtspRequest.headers.get(RtspHeaders.CSEQ) != null);
    ...
    public static ImmutableList<String> serializeResponse(RtspResponse rtspResponse) {
        Preconditions.checkArgument(rtspResponse.headers.get(RtspHeaders.CSEQ) != null);
        ImmutableList.Builder builder = new ImmutableList.Builder();
    ...
    public static Uri removeUserInfo(Uri uri) {
        ...
        String str = (String) Preconditions.checkNotNull(uri.getEncodedAuthority());
    ...
    public static RtspResponse parseResponse(List<String> list) {
        ...
        int i = Integer.parseInt((String) Preconditions.checkNotNull(matcher.group(1)));
        int iIndexOf = list.indexOf("");
        Preconditions.checkArgument(iIndexOf > 0);
    ...
    public static RtspRequest parseRequest(List<String> list) {
        ...
        Preconditions.checkArgument(matcher.matches());
        int methodString = parseMethodString((String) Preconditions.checkNotNull(matcher.group(1)));
        Uri uri = Uri.parse((String) Preconditions.checkNotNull(matcher.group(2)));
        int iIndexOf = list.indexOf("");
        Preconditions.checkArgument(iIndexOf > 0);
    ...
    public static ImmutableList<Integer> parsePublicHeader(String str) {
        ...
        for (String str2 : Util.split(str, ",\\s?")) {
            ...
            if (methodString != 0) {
                builder.add(Integer.valueOf(methodString));
            }
        }
        return builder.build();
    }
    ...
    public static RtspAuthenticationInfo parseWwwAuthenticateHeader(String str) throws ParserException {
        ...
        if (matcher.find()) {
            return new RtspAuthenticationInfo(2, (String) Preconditions.checkNotNull(matcher.group(1)), (String) Preconditions.checkNotNull(matcher.group(3)), Strings.nullToEmpty(matcher.group(4)));
        }
        Matcher matcher2 = WWW_AUTHENTICATION_HEADER_BASIC_PATTERN.matcher(str);
        if (matcher2.matches()) {
            return new RtspAuthenticationInfo(1, (String) Preconditions.checkNotNull(matcher2.group(1)), "", "");
        }
