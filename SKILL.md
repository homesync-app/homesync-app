...
1. **Director (Blasbot)**: El líder. Divide el problema, asigna roles y aprueba planes.
...
1. **Activa el Líder**: Pídele a Antigravity: _"Usa la habilidad Equipo Alejabot para inicializar este proyecto"_.
