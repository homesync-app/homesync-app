...
final class RtspMessageChannel implements Closeable {
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m272x8c7d4ead(bArrConvertMessageToByteArray, list);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$send$0$androidx-media3-exoplayer-rtsp-RtspMessageChannel$Sender, reason: not valid java name */
        /* synthetic */ void m272x8c7d4ead(byte[] bArr, List list) {
            try {
    ...
    private static final class MessageParser {
            ...
            while (immutableListAddMessageLine == null) {
                if (this.state == 3) {
                    ...
                    if (j > 0) {
                        ...
                        Preconditions.checkState(iCheckedCast != -1);
        ...
        private ImmutableList<String> addMessageLine(byte[] bArr) throws ParserException {
            Preconditions.checkArgument(bArr.length >= 2 && bArr[bArr.length - 2] == 13 && bArr[bArr.length - 1] == 10);
        ...
        private ImmutableList<String> addMessageBody(byte[] bArr) {
            String str;
            Preconditions.checkState(this.state == 3);
