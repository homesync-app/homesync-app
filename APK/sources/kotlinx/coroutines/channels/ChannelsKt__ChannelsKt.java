...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    /* JADX INFO: compiled from: Channels.kt */
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0003H\n"}, d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 0, 0}, xi = NalUnitUtil.H265_NAL_UNIT_TYPE_UNSPECIFIED)
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM600constructorimpl = Result.m600constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM600constructorimpl = Result.m600constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2127boximpl(Result.m607isSuccessimpl(objM600constructorimpl) ? ChannelResult.INSTANCE.m2142successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2140closedJP2dKIU(Result.m603exceptionOrNullimpl(objM600constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2112trySendJP2dKIU = sendChannel.mo2112trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2137isSuccessimpl(sendChannel.mo2112trySendJP2dKIU(obj))) {
            return;
        }
