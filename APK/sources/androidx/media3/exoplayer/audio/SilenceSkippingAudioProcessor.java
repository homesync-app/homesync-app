...
public final class SilenceSkippingAudioProcessor extends BaseAudioProcessor {
    ...
    private void shortenSilenceSilenceUntilNoise(ByteBuffer byteBuffer) {
        ...
        Preconditions.checkState(i5 <= this.maybeSilenceBuffer.length);
        ...
        if (i == bArr.length || z) {
            if (this.outputSilenceFramesSinceNoise == 0) {
                if (z) {
                    ...
                    Preconditions.checkState(i >= bArr.length / 2);
            ...
            Preconditions.checkState(i >= iCalculateShortenedSilenceLength);
    ...
    private int calculateShortenedSilenceLength(int i) {
        ...
        Preconditions.checkState(iDurationUsToFrames >= 0);
