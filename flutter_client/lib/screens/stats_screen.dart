...
import '../widgets/faceoff_widget.dart';
...
class _StatsScreenState extends State<StatsScreen>
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      if (mounted) {
        final rawRanking = results[2] as List<Map<String, dynamic>>;
        final members = results[5] as List<Map<String, dynamic>>;
        ...
        setState(() {
          _taskStats = results[0] as List<Map<String, dynamic>>;
          _memberStats = results[1] as List<Map<String, dynamic>>;
          _weeklyRanking = mergedRanking;
          _xpHistory = results[3] as List<Map<String, dynamic>>;
          _coinHistory = results[4] as List<Map<String, dynamic>>;
          _isLoading = false;
        });
      }
    } catch (e) {
