-- Reconstructed from remote migration history (version 20260227222554).
...
-- Update get_member_activity_stats to include avatar_url
...
-- Update get_weekly_ranking to include user_id and avatar_url
