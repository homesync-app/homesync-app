...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    class AnonymousClass1 implements PlatformViewsChannel.PlatformViewsHandler {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i)) {
                ...
                virtualDisplayController.resize(physicalPixels, physicalPixels2, new Runnable() { // from class: io.flutter.plugin.platform.PlatformViewsController$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m546x7b26d3(virtualDisplayController, displayDensity, platformViewBufferResized);
                    }
                });
                return;
            }
        ...
        /* synthetic */ void m546x7b26d3(VirtualDisplayController virtualDisplayController, float f, PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
    ...
    public long configureForVirtualDisplay(PlatformView platformView, final PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        VirtualDisplayController virtualDisplayControllerCreate = VirtualDisplayController.create(this.context, this.accessibilityEventsDelegate, platformView, platformViewRenderTargetMakePlatformViewRenderTarget, toPhysicalPixels(platformViewCreationRequest.logicalWidth), toPhysicalPixels(platformViewCreationRequest.logicalHeight), platformViewCreationRequest.viewId, null, new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda2
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m543x9514d2a0(platformViewCreationRequest, view, z);
            }
        });
    ...
    /* synthetic */ void m543x9514d2a0(PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
    ...
    public long configureForTextureLayerComposition(PlatformView platformView, final PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view2, boolean z) {
                this.f$0.m542x6d74e942(platformViewCreationRequest, view2, z);
            }
        });
    ...
    /* synthetic */ void m542x6d74e942(PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
            this.platformViewsChannel.invokeViewFocused(platformViewCreationRequest.viewId);
            return;
        }
    ...
    public MotionEvent toMotionEvent(float f, PlatformViewTouch platformViewTouch, boolean z) {
        ...
        if (!z && motionEventPop != null) {
            if (motionEventPop.getPointerCount() == platformViewTouch.pointerCount && motionEventPop.getAction() == platformViewTouch.action) {
                translateMotionEvent(motionEventPop, pointerCoordsArr);
                return motionEventPop;
            }
            return MotionEvent.obtain(motionEventPop.getDownTime(), motionEventPop.getEventTime(), platformViewTouch.action, platformViewTouch.pointerCount, pointerPropertiesArr, pointerCoordsArr, motionEventPop.getMetaState(), motionEventPop.getButtonState(), motionEventPop.getXPrecision(), motionEventPop.getYPrecision(), motionEventPop.getDeviceId(), motionEventPop.getEdgeFlags(), motionEventPop.getSource(), motionEventPop.getFlags());
        }
    ...
    boolean initializePlatformViewIfNeeded(final int i) {
        ...
        flutterMutatorView.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda0
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view2, boolean z) {
                this.f$0.m544x63d72b3e(i, view2, z);
            }
        });
    ...
    /* synthetic */ void m544x63d72b3e(int i, View view, boolean z) {
        if (z) {
