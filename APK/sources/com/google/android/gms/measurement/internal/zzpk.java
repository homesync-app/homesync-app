...
public final class zzpk extends zzos {
    ...
    final zzoh zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM672m = UByte$$ExternalSyntheticBackport0.m672m((Object[]) zzicVar2.zzc().zzk(str, zzfy.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM672m);
        zzicVar2.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(133005L), setM672m);
        ...
        zzN(builder, "app_instance_id", strZzV, setM672m);
        zzN(builder, "rdid", zzicVar.zzP(), setM672m);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM672m);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjm.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM672m);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM672m);
        ...
        zzN(builder, "os_version", strZzD, setM672m);
        zzN(builder, Constants.TIMESTAMP, String.valueOf(zzhrVar.zzn()), setM672m);
        boolean zZzS = zzicVar.zzS();
        String str3 = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
        if (zZzS) {
            zzN(builder, "lat", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, setM672m);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM672m);
        zzN(builder, "trigger_uri_source", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, setM672m);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM672m);
        zzN(builder, "request_uuid", str2, setM672m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzat).split("\\|"), bundle, setM672m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzas).split("\\|"), bundle2, setM672m);
        if (true != zzicVar.zzaC()) {
            str3 = SessionDescription.SUPPORTED_SDP_VERSION;
        }
        zzN(builder, "dma", str3, setM672m);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM672m);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM672m);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM672m);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM672m);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM672m);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM672m);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM672m);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM672m);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM672m);
            }
        }
            ...
            if (zzidVar != null) {
                ...
                if (zzidVar.zzaC()) {
                    ...
                    for (com.google.android.gms.internal.measurement.zzhl zzhlVar : zzhoVarZzaD.zza()) {
                        ...
                        zzS(sb, 3, SessionDescription.ATTR_TYPE, iZzc != 1 ? iZzc != 2 ? iZzc != 3 ? iZzc != 4 ? "AD_PERSONALIZATION" : "AD_USER_DATA" : "ANALYTICS_STORAGE" : "AD_STORAGE" : "CONSENT_TYPE_UNSPECIFIED");
