...
final class RtpH265Reader implements RtpPayloadReader {
    ...
    private void processFragmentationUnitPacket(ParsableByteArray parsableByteArray, int i) throws ParserException {
        ...
        if (z) {
            ...
            this.fuScratchBuffer.getData()[1] = (byte) ((i3 << 1) & WorkQueueKt.MASK);
    ...
    private int writeStartCode() {
        ...
        ((TrackOutput) Preconditions.checkNotNull(this.trackOutput)).sampleData(this.nalStartCodeArray, iBytesLeft);
        return iBytesLeft;
    }
