...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo362clone = transition.mo362clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo362clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo362clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo362clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo362clone = transition.mo362clone();
        sceneChangeSetup(viewGroup, transitionMo362clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo362clone);
    }
