...
public final class RtspMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public RtspMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            if (shouldForceUseRtpTcp(mediaItem)) {
        ...
        private boolean shouldForceUseRtpTcp(MediaItem mediaItem) {
            ...
            String scheme = ((MediaItem.LocalConfiguration) Preconditions.checkNotNull(mediaItem.localConfiguration)).uri.getScheme();
    ...
    RtspMediaSource(MediaItem mediaItem, RtpDataChannel.Factory factory, String str, SocketFactory socketFactory, boolean z) {
        ...
        this.userAgent = str;
        this.uri = maybeConvertRtsptUriScheme(((MediaItem.LocalConfiguration) Preconditions.checkNotNull(mediaItem.localConfiguration)).uri);
        this.socketFactory = socketFactory;
        this.debugLoggingEnabled = z;
    }
    ...
    private static Uri maybeConvertRtsptUriScheme(Uri uri) {
        ...
        return (scheme == null || !Ascii.equalsIgnoreCase("rtspt", scheme)) ? uri : Uri.parse("rtsp" + uri.toString().substring(5));
    }
