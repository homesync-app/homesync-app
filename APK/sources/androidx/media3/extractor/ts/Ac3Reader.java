...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        if (this.format == null || ac3SyncframeInfo.channelCount != this.format.channelCount || ac3SyncframeInfo.sampleRate != this.format.sampleRate || !Objects.equals(ac3SyncframeInfo.mimeType, this.format.sampleMimeType)) {
