...
final class RtspClient implements Closeable {
    ...
    public void startPlayback(long j) {
        this.messageSender.sendPlayRequest(this.uri, j, (String) Preconditions.checkNotNull(this.sessionId));
    }
    ...
    public void seekToUs(long j) {
        if (this.rtspState == 2 && !this.hasPendingPauseRequest) {
            this.messageSender.sendPauseRequest(this.uri, (String) Preconditions.checkNotNull(this.sessionId));
        }
    ...
    public void close() throws IOException {
        ...
        if (keepAliveMonitor != null) {
            ...
            this.messageSender.sendTeardownRequest(this.uri, (String) Preconditions.checkNotNull(this.sessionId));
        }
    ...
    private Socket getSocket(Uri uri) throws IOException {
        ...
        return this.socketFactory.createSocket((String) Preconditions.checkNotNull(uri.getHost()), uri.getPort() > 0 ? uri.getPort() : RtspMessageChannel.DEFAULT_RTSP_PORT);
    }
    ...
    public static ImmutableList<RtspMediaTrack> buildTrackList(RtspDescribeResponse rtspDescribeResponse, Uri uri) {
        ...
        for (int i = 0; i < rtspDescribeResponse.sessionDescription.mediaDescriptionList.size(); i++) {
            ...
            if (RtpPayloadFormat.isFormatSupported(mediaDescription)) {
                builder.add(new RtspMediaTrack(rtspDescribeResponse.headers, mediaDescription, uri));
            }
        }
    ...
    private final class MessageSender {
        ...
        public void sendDescribeRequest(Uri uri, String str) {
            sendRequest(getRequestWithCommonHeaders(2, str, ImmutableMap.of("Accept", MimeTypes.APPLICATION_SDP), uri));
        }
        ...
        private RtspRequest getRequestWithCommonHeaders(int i, String str, Map<String, String> map, Uri uri) {
            ...
            if (RtspClient.this.rtspAuthenticationInfo != null) {
                Preconditions.checkNotNull(RtspClient.this.rtspAuthUserInfo);
                try {
        ...
        private void sendRequest(RtspRequest rtspRequest) {
            int i = Integer.parseInt((String) Preconditions.checkNotNull(rtspRequest.headers.get(RtspHeaders.CSEQ)));
            Preconditions.checkState(RtspClient.this.pendingRequests.get(i) == null);
    ...
    final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        public void m269x5ebb245a(List<String> list) {
        ...
        private void handleRtspRequest(List<String> list) {
            RtspClient.this.messageSender.sendMethodNotAllowedResponse(Integer.parseInt((String) Preconditions.checkNotNull(RtspMessageUtil.parseRequest(list).headers.get(RtspHeaders.CSEQ))));
        }
        ...
        private void handleRtspResponse(List<String> list) {
            ...
            int i = Integer.parseInt((String) Preconditions.checkNotNull(response.headers.get(RtspHeaders.CSEQ)));
            ...
            try {
                try {
                    ...
                    if (i3 == 461) {
                        ...
                        String str6 = (String) Preconditions.checkNotNull(rtspRequest.headers.get(RtspHeaders.TRANSPORT));
                    ...
                    if (i3 == 301 || i3 == 302) {
                        ...
                        RtspClient.this.uri = Uri.parse(str7);
        ...
        private void onSetupResponseReceived(RtspSetupResponse rtspSetupResponse) {
            Preconditions.checkState(RtspClient.this.rtspState != -1);
        ...
        private void onPlayResponseReceived(RtspPlayResponse rtspPlayResponse) {
            ...
            if (RtspClient.this.keepAliveMonitor == null) {
                ...
                rtspClient.keepAliveMonitor = rtspClient2.new KeepAliveMonitor(rtspClient2.sessionTimeoutMs / 2);
