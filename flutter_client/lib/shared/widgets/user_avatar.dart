...
class UserAvatar {
  ...
  static const List<Map<String, dynamic>> premiumAvatars = [
    {
      'id': 'premium_mate_boy',
      'url': 'assets/images/premium_3d_avatars/premium_mate_boy.webp',
      'name': 'Matecito',
      'color': Color(0xFFFFE7BA),
    },
    {
      'id': 'premium_keys_girl',
      'url': 'assets/images/premium_3d_avatars/premium_keys_girl.webp',
      'name': 'Llaves de Casa',
      'color': Color(0xFFFFD3E0),
    },
    {
      'id': 'premium_market_dog',
      'url': 'assets/images/premium_3d_avatars/premium_market_dog.webp',
      'name': 'Perrito Super',
      'color': Color(0xFFD8ECFA),
    },
    {
      'id': 'premium_orange_cat',
      'url': 'assets/images/premium_3d_avatars/premium_orange_cat.webp',
      'name': 'Gatito Naranja',
      'color': Color(0xFFFFD180),
    },
    {
      'id': 'premium_paper_plane_kid',
      'url': 'assets/images/premium_3d_avatars/premium_paper_plane_kid.webp',
      'name': 'Mini Aventurero',
      'color': Color(0xFFFFE0C2),
    },
    {
      'id': 'premium_star_girl',
      'url': 'assets/images/premium_3d_avatars/premium_star_girl.webp',
      'name': 'Mini Estrella',
      'color': Color(0xFFFFD8C7),
    },
    {
      'id': 'premium_key_bird',
      'url': 'assets/images/premium_3d_avatars/premium_key_bird.webp',
      'name': 'Pajarito Llaves',
      'color': Color(0xFFFFE7A8),
    },
    {
      'id': 'premium_tool_adult_man',
      'url': 'assets/images/premium_3d_avatars/premium_tool_adult_man.webp',
      'name': 'Manos a Casa',
