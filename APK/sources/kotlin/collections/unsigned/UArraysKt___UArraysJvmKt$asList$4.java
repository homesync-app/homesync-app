...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m1129containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UShort.m880boximpl(m1130getMh2AYeg(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1131indexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1132lastIndexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UShortArray.m945getSizeimpl(this.f6$$v$c$kotlinUShortArray$$this$asList$0);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UShortArray.m947isEmptyimpl(this.f6$$v$c$kotlinUShortArray$$this$asList$0);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m1129containsxj2QHRw(short element) {
        return UShortArray.m940containsxj2QHRw(this.f6$$v$c$kotlinUShortArray$$this$asList$0, element);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public short m1130getMh2AYeg(int index) {
        return UShortArray.m944getMh2AYeg(this.f6$$v$c$kotlinUShortArray$$this$asList$0, index);
    }

    /* JADX INFO: renamed from: indexOf-xj2QHRw, reason: not valid java name */
    public int m1131indexOfxj2QHRw(short element) {
    ...
    public int m1132lastIndexOfxj2QHRw(short element) {
