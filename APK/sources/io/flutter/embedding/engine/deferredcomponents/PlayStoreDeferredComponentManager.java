...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
        ...
        if (str2 == null) {
            ...
            this.splitInstallManager.startInstall(SplitInstallRequest.newBuilder().addModule(str2).build()).addOnSuccessListener(new OnSuccessListener() { // from class: io.flutter.embedding.engine.deferredcomponents.PlayStoreDeferredComponentManager$$ExternalSyntheticLambda0
                public final void onSuccess(Object obj) {
                    this.f$0.m531x3d4be899(str2, i, (Integer) obj);
                }
                ...
                public final void onFailure(Exception exc) {
                    this.f$0.m532x6bfd52b8(i, str, exc);
                }
            });
        }
    }
    ...
    /* synthetic */ void m531x3d4be899(String str, int i, Integer num) {
    ...
    /* synthetic */ void m532x6bfd52b8(int i, String str, Exception exc) {
        ...
        if (errorCode == -6) {
            ...
            this.flutterJNI.deferredComponentInstallFailure(i, String.format("Install of deferred component module \"%s\" failed with error %d: %s", str, Integer.valueOf(errorCode), splitInstallException.getMessage()), false);
        }
    }
