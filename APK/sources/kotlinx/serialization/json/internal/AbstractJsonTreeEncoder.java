...
abstract class AbstractJsonTreeEncoder extends NamedValueEncoder implements JsonEncoder {
    ...
    */
    ...
    private final C01971 inlineUnsignedNumberEncoder(final String tag) {
        return new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder.inlineUnsignedNumberEncoder.1
            ...
            public void encodeInt(int value) {
                putUnquotedString(UByte$$ExternalSyntheticBackport0.m670m(UInt.m700constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long value) {
                putUnquotedString(UByte$$ExternalSyntheticBackport0.m(ULong.m779constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte value) {
                putUnquotedString(UByte.m662toStringimpl(UByte.m618constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short value) {
                putUnquotedString(UShort.m930toStringimpl(UShort.m886constructorimpl(value)));
            }
        };
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        if (str != null) {
            if (jsonTreeListEncoder instanceof JsonTreeMapEncoder) {
                ...
                jsonTreeMapEncoder2.putElement(Constants.KEY, JsonElementKt.JsonPrimitive(str));
