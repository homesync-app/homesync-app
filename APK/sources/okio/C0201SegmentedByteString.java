...
public final class C0201SegmentedByteString extends ByteString {
    ...
    public C0201SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0201SegmentedByteString c0201SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0201SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c0201SegmentedByteString;
        }
