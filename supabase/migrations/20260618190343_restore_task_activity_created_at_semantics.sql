-- Keep the household movement registered today while preserving the real
-- user-selected task completion date in metadata.
--
-- Previous migration made household_activities.created_at equal completed_at,
-- which removed backfilled completions from today's household movement feed.
-- The feed should answer "what was registered today"; task detail and labels
-- should answer "when was it actually done".
