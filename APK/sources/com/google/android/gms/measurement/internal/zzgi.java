...
public final class zzgi extends zzg {
    ...
    @Override // com.google.android.gms.measurement.internal.zzg
    @org.checkerframework.checker.nullness.qual.EnsuresNonNull({"appId", "appStore", io.flutter.plugins.firebase.auth.Constants.APP_NAME, "gmpAppId", "gaAppId"})
    /*
    ...
    */
    ...
    final void zzi() {
        ...
        zzicVar.zzaV().zzj().zza(String.format("Resetting session stitching token to %s", str == null ? AbstractJsonLexerKt.NULL : "not null"));
        this.zzm = str;
