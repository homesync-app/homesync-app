            ...
            public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
                ...
                switch (str) {
                    case "SensitiveContent.getContentSensitivity":
                        try {
                            result.success(Integer.valueOf(SensitiveContentChannel.this.serializeContentSensitivity(Integer.valueOf(SensitiveContentChannel.this.sensitiveContentMethodHandler.getContentSensitivity()).intValue())));
                            break;
