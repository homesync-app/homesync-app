...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m773boximpl(ULong.m779constructorimpl(getMostSignificantBits())), ULong.m773boximpl(ULong.m779constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2094toUByteArrayTcUX1vc() {
        return UByteArray.m676constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m779constructorimpl(j) ^ Long.MIN_VALUE, ULong.m779constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m779constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m779constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2096fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2095fromUByteArrayGBYM_sE(byte[] ubyteArray) {
