    ...
    private void processSample() throws ParserException {
        ...
        for (String line = parsableByteArray.readLine(); !TextUtils.isEmpty(line); line = parsableByteArray.readLine()) {
            if (line.startsWith("X-TIMESTAMP-MAP")) {
                ...
                timestampUs = WebvttParserUtil.parseTimestampUs((String) Preconditions.checkNotNull(matcher.group(1)));
                jPtsToUs = TimestampAdjuster.ptsToUs(Long.parseLong((String) Preconditions.checkNotNull(matcher2.group(1))));
            }
        }
        ...
        long timestampUs2 = WebvttParserUtil.parseTimestampUs((String) Preconditions.checkNotNull(matcherFindNextCueHeader.group(1)));
