...
public final class zzaeq extends AsyncTask<Void, Void, zzaep> {
    ...
    public final zzaep doInBackground(Void... voidArr) {
        try {
            ...
            httpURLConnectionZza.setConnectTimeout(ExoPlayer.DEFAULT_STUCK_PLAYING_NOT_ENDING_TIMEOUT_MS);
    ...
    public zzaeq(String str, String str2, Intent intent, FirebaseApp firebaseApp, zzaes zzaesVar) {
        ...
        builderBuildUpon.appendPath("getProjectConfig").appendQueryParameter(Constants.KEY, strCheckNotEmpty).appendQueryParameter("androidPackageName", str).appendQueryParameter("sha1Cert", (String) Preconditions.checkNotNull(str2));
