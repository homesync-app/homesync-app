...
const sourceHtml = 'C:\\Users\\Blas_\\Downloads\\homesync_play_screenshots.html';
const htmlPath = 'C:\\Users\\Blas_\\Downloads\\homesync_play_final_no_status.html';
const outputDir = 'C:\\Users\\Blas_\\Downloads\\homesync_play_final_8_no_status';
...
async function prepareHtml() {
  ...
  html = html.replaceAll('assets_clean/', 'assets/');
  html = html.replace(
    `.phone-inner img{
  ...
  html = html.replace(
    `.phone::before{content:'';position:absolute;top:32px;left:50%;transform:translateX(-50%);width:170px;height:38px;border-radius:24px;background:#000;z-index:50}`,
    `.phone::before{content:'';position:absolute;top:46px;left:50%;transform:translateX(-50%);width:16px;height:16px;border-radius:999px;background:#121212;z-index:50}`,
  );
