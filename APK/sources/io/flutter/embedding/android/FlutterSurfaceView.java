...
public class FlutterSurfaceView extends SurfaceView implements RenderSurface {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isContentSizingEnabled) {
            FlutterMeasureSpec.onMeasure(i, i2, new FlutterMeasureSpec.MeasureCallback() { // from class: io.flutter.embedding.android.FlutterSurfaceView$$ExternalSyntheticLambda0
