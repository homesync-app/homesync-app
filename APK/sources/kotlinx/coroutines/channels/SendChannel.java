...
public interface SendChannel<E> {
    ...
    Object mo2112trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2137isSuccessimpl(objMo2112trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2131exceptionOrNullimpl = ChannelResult.m2131exceptionOrNullimpl(objMo2112trySendJP2dKIU);
