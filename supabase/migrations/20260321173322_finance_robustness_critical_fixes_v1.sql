-- Reconstructed from remote migration history (version 20260321173322).
...
BEGIN
  ...
  IF NEW.category = 'groceries' THEN
    action_verb := 'comprâ”œâ”‚ en';
  ELSE
    action_verb := 'gastâ”œâ”‚ en';
  END IF;

  IF NEW.title = 'Liquidacion de deuda' THEN
    display_title := 'â”¬Ã­Deuda saldada!';
    action_verb := 'saldâ”œâ”‚ la deuda con';
  ELSE
  ...
  LOOP
    ...
    IF v_is_visible THEN
      INSERT INTO public.notifications (
        ...
        display_title,
        CASE
          WHEN NEW.title = 'Liquidacion de deuda' THEN creator_name || ' saldâ”œâ”‚ su deuda de $ ' || NEW.amount
