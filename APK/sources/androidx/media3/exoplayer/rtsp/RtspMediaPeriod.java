...
final class RtspMediaPeriod implements MediaPeriod {
    ...
    public TrackGroupArray getTrackGroups() {
        ...
        return new TrackGroupArray((TrackGroup[]) ((ImmutableList) Preconditions.checkNotNull(this.trackGroups)).toArray(new TrackGroup[0]));
    }
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr.length; i2++) {
            ...
            if (exoTrackSelection != null) {
                ...
                int iIndexOf = ((ImmutableList) Preconditions.checkNotNull(this.trackGroups)).indexOf(trackGroup);
                this.selectedLoadInfos.add(((RtspLoaderWrapper) Preconditions.checkNotNull(this.rtspLoaderWrappers.get(iIndexOf))).loadInfo);
    ...
    private static ImmutableList<TrackGroup> buildTrackGroups(ImmutableList<RtspLoaderWrapper> immutableList) {
        ...
        for (int i = 0; i < immutableList.size(); i++) {
            builder.add(new TrackGroup(Integer.toString(i), (Format) Preconditions.checkNotNull(immutableList.get(i).sampleQueue.getUpstreamFormat())));
        }
    ...
    final class InternalListener implements Loader.Callback<RtpDataLoadable>, SampleQueue.UpstreamFormatChangedListener, RtspClient.SessionInfoListener, RtspClient.PlaybackEventListener {
        ...
        public void onPlaybackStarted(long j, ImmutableList<RtspTrackTiming> immutableList) {
            ...
            for (int i = 0; i < immutableList.size(); i++) {
                arrayList.add((String) Preconditions.checkNotNull(immutableList.get(i).uri.getPath()));
            }
    ...
    private final class RtspLoaderWrapper {
        ...
        public void resumeLoad() {
            Preconditions.checkState(this.canceled);
            this.canceled = false;
            RtspMediaPeriod.this.updateLoadingFinished();
            startLoading();
        }
        ...
        public RtpLoadInfo(RtspMediaTrack rtspMediaTrack, int i, TrackOutput trackOutput, RtpDataChannel.Factory factory) {
            ...
            this.loadable = new RtpDataLoadable(i, rtspMediaTrack, new RtpDataLoadable.EventListener() { // from class: androidx.media3.exoplayer.rtsp.RtspMediaPeriod$RtpLoadInfo$$ExternalSyntheticLambda0
                ...
                public final void onTransportReady(String str, RtpDataChannel rtpDataChannel) {
                    this.f$0.m270x4b88a535(str, rtpDataChannel);
                }
            }, new ExtractorOutputImpl(trackOutput), factory);
        }

        /* JADX INFO: renamed from: lambda$new$0$androidx-media3-exoplayer-rtsp-RtspMediaPeriod$RtpLoadInfo, reason: not valid java name */
        /* synthetic */ void m270x4b88a535(String str, RtpDataChannel rtpDataChannel) {
            this.transport = str;
