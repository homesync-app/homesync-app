...
public final class UnsignedKt {
    ...
    public static final int m957uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m700constructorimpl((int) ((((long) i) & KeyboardMap.kValueMask) % (((long) i2) & KeyboardMap.kValueMask)));
    }
    ...
    public static final long m958ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m779constructorimpl(0L) : ULong.m779constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m779constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m779constructorimpl(j3 + ((long) (Long.compare(ULong.m779constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m779constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }
    ...
    public static final long m959ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m779constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m779constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m779constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m779constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.m700constructorimpl(UInt.m700constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m700constructorimpl(Integer.MAX_VALUE));
    }
    ...
    private static final String uintToString(int i, int i2) {
        return ulongToString(((long) i) & KeyboardMap.kValueMask, i2);
    }
