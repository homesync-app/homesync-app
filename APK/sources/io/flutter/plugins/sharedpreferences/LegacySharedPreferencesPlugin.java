...
public class LegacySharedPreferencesPlugin implements FlutterPlugin, Messages.SharedPreferencesApi {
    ...
    public Boolean setDouble(String str, Double d) {
        return Boolean.valueOf(this.preferences.edit().putString(str, "VGhpcyBpcyB0aGUgcHJlZml4IGZvciBEb3VibGUu" + Double.toString(d.doubleValue())).commit());
    }
    ...
    private Object transformPref(String str, Object obj) {
        if (obj instanceof String) {
            ...
            if (str2.startsWith("VGhpcyBpcyB0aGUgcHJlZml4IGZvciBhIGxpc3Qu")) {
                if (!str2.startsWith("VGhpcyBpcyB0aGUgcHJlZml4IGZvciBhIGxpc3Qu!")) {
                    return this.listEncoder.decode(str2.substring("VGhpcyBpcyB0aGUgcHJlZml4IGZvciBhIGxpc3Qu".length()));
                }
            } else {
                if (str2.startsWith(BIG_INTEGER_PREFIX)) {
                    return new BigInteger(str2.substring(BIG_INTEGER_PREFIX.length()), 36);
                }
                if (str2.startsWith("VGhpcyBpcyB0aGUgcHJlZml4IGZvciBEb3VibGUu")) {
                    return Double.valueOf(str2.substring("VGhpcyBpcyB0aGUgcHJlZml4IGZvciBEb3VibGUu".length()));
                }
            }
