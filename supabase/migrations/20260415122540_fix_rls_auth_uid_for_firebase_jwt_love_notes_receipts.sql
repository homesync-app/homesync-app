-- Reconstructed from remote migration history (version 20260415122540).
-- Source: supabase_migrations.schema_migrations on project tfavamqszdkoeabpyxms.


-- love_notes: replace auth.uid() with current_app_user_id()
...
-- receipt_scan_logs: replace auth.uid() with current_app_user_id()
