...
public class FlutterJNI {
    ...
    public void loadLibrary(Context context) {
        ...
        ReLinker.log(new ReLinker.Logger() { // from class: io.flutter.embedding.engine.FlutterJNI$$ExternalSyntheticLambda0
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            return FlutterImageDecoder.decodeImage(byteBuffer, new FlutterImageDecoder.HeaderListener() { // from class: io.flutter.embedding.engine.FlutterJNI$$ExternalSyntheticLambda1
                @Override // io.flutter.embedding.engine.image.FlutterImageDecoder.HeaderListener
                public final void onImageHeader(int i, int i2) {
                    FlutterJNI.nativeImageHeaderCallback(j, i, i2);
                }
            });
        }
        return null;
    ...
    public void hidePlatformView2(int i) {
        ...
        platformViewsController2.hidePlatformView(i);
    }
    ...
    public float getScaledFontSize(float f, int i) {
        ...
        DisplayMetrics pastDisplayMetrics = settingsChannel == null ? null : settingsChannel.getPastDisplayMetrics(i);
