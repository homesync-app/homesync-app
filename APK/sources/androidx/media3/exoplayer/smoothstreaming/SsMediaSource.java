...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(SsChunkSource.Factory factory, DataSource.Factory factory2) {
            this.chunkSourceFactory = (SsChunkSource.Factory) Preconditions.checkNotNull(factory);
        ...
        public SsMediaSource createMediaSource(SsManifest ssManifest, MediaItem mediaItem) {
            ...
            Preconditions.checkArgument(!ssManifestCopy.isLive);
            ...
            return new SsMediaSource(mediaItemBuild, ssManifest2, null, null, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, factory == null ? null : factory.createCmcdConfiguration(mediaItemBuild), this.drmSessionManagerProvider.get(mediaItemBuild), this.loadErrorHandlingPolicy, this.livePresentationDelayMs, this.downloadExecutorSupplier);
        }
        ...
        public SsMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            CmcdConfiguration.Factory factory = this.cmcdConfigurationFactory;
            return new SsMediaSource(mediaItem, null, this.manifestDataSourceFactory, filteringManifestParser, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, factory == null ? null : factory.createCmcdConfiguration(mediaItem), this.drmSessionManagerProvider.get(mediaItem), this.loadErrorHandlingPolicy, this.livePresentationDelayMs, this.downloadExecutorSupplier);
        }
    ...
    private SsMediaSource(MediaItem mediaItem, SsManifest ssManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends SsManifest> parser, SsChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, CmcdConfiguration cmcdConfiguration, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j, Supplier<ReleasableExecutor> supplier) {
        Preconditions.checkState(ssManifest == null || !ssManifest.isLive);
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        if (this.downloadExecutorSupplier != null) {
            ...
            loader = new Loader("SsMediaSource");
        }
