...
final class Sonic {
    ...
    public static long getExpectedFrameCountAfterProcessorApplied(int i, int i2, float f, float f2, long j) {
        ...
        return bigDecimalValueOf.divide(bigDecimal, RoundingMode.HALF_EVEN).longValueExact() - calculateAccumulatedTruncationErrorForResampling(bigDecimalValueOf, BigDecimal.valueOf(i), bigDecimal);
    }
    ...
    private int findPitchPeriod(int i) {
        ...
        if (this.channelCount == 1 && i3 == 1) {
            ...
            if (i3 != 1) {
                ...
                if (this.channelCount == 1) {
                    iFindPitchPeriodInRangeWithDownsampleBuffer = this.impl.findPitchPeriodInRangeWithInputBuffer(i, i6, i7);
                } else {
        ...
        int i10 = this.impl.isPreviousPeriodBetter() ? this.prevPeriod : iFindPitchPeriodInRangeWithDownsampleBuffer;
    ...
    private int skipPitchPeriod(int i, double d, int i2) {
        ...
        if (d >= 2.0d) {
            ...
            double d3 = ((((double) i2) * (2.0d - d)) / (d - 1.0d)) + this.accumulatedSpeedAdjustmentError;
    ...
    private int insertPitchPeriod(int i, double d, int i2) {
        ...
        if (d < 0.5d) {
            ...
            double d3 = ((((double) i2) * ((2.0d * d) - 1.0d)) / (1.0d - d)) + this.accumulatedSpeedAdjustmentError;
            int iRound2 = (int) Math.round(d3);
            this.remainingInputToCopyFrameCount = iRound2;
            this.accumulatedSpeedAdjustmentError = d3 - ((double) iRound2);
            i3 = i2;
        ...
        Object inputBuffer = this.impl.getInputBuffer();
        int i5 = this.channelCount * i;
        Object outputBuffer = this.impl.getOutputBuffer();
        int i6 = this.outputFrameCount;
        int i7 = this.channelCount;
        System.arraycopy(inputBuffer, i5, outputBuffer, i6 * i7, i7 * i2);
    ...
    private void changeSpeed(double d) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                ...
                if (d > 1.0d) {
                    iInsertPitchPeriod = iFindPitchPeriod + skipPitchPeriod(i2, d, iFindPitchPeriod);
                } else {
                    iInsertPitchPeriod = insertPitchPeriod(i2, d, iFindPitchPeriod);
                }
            }
