...
public class PlaybackException extends Exception {
    ...
    private static Bundle getExtrasFromBundle(Bundle bundle) {
        Bundle bundleConvertToNullIfInvalid = Util.convertToNullIfInvalid(bundle.getBundle(FIELD_BUNDLE_EXTRAS));
        return bundleConvertToNullIfInvalid != null ? bundleConvertToNullIfInvalid : Bundle.EMPTY;
    }
