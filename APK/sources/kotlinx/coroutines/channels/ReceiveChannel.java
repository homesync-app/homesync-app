...
public interface ReceiveChannel<E> {
    ...
    Object mo2119receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2120tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2120tryReceivePtdJZtk = receiveChannel.mo2120tryReceivePtdJZtk();
            if (ChannelResult.m2137isSuccessimpl(objMo2120tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2133getOrThrowimpl(objMo2120tryReceivePtdJZtk);
            }
            Throwable thM2131exceptionOrNullimpl = ChannelResult.m2131exceptionOrNullimpl(objMo2120tryReceivePtdJZtk);
            if (thM2131exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2131exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2119receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2132getOrNullimpl(r4)
                return r4
            */
