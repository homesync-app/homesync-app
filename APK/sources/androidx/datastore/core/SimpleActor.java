...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM2132getOrNullimpl = ChannelResult.m2132getOrNullimpl(((SimpleActor) this).messageQueue.mo2120tryReceivePtdJZtk());
                        if (objM2132getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM2132getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo2112trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM2131exceptionOrNullimpl = ChannelResult.m2131exceptionOrNullimpl(obj);
            if (thM2131exceptionOrNullimpl != null) {
                throw thM2131exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m2137isSuccessimpl(obj)) {
