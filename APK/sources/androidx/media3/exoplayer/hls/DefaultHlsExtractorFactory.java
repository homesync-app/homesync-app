...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    public BundledHlsMediaChunkExtractor createExtractor(Uri uri, Format format, List<Format> list, TimestampAdjuster timestampAdjuster, Map<String, List<String>> map, ExtractorInput extractorInput, PlayerId playerId) throws IOException {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            Extractor extractor2 = (Extractor) Preconditions.checkNotNull(createExtractorByFileType(iIntValue, format, list, timestampAdjuster));
        ...
        return new BundledHlsMediaChunkExtractor((Extractor) Preconditions.checkNotNull(extractor), format, timestampAdjuster, this.subtitleParserFactory, this.parseSubtitlesDuringExtraction);
    }
    ...
    private static boolean isFmp4Variant(Format format) {
        ...
        return (metadata == null || metadata.getFirstMatchingEntry(HlsTrackMetadataEntry.class, new Predicate() { // from class: androidx.media3.exoplayer.hls.DefaultHlsExtractorFactory$$ExternalSyntheticLambda0
    ...
    static /* synthetic */ boolean lambda$isFmp4Variant$0(HlsTrackMetadataEntry hlsTrackMetadataEntry) {
