-- Reconstructed from remote migration history (version 20260420104657).
-- Source: supabase_migrations.schema_migrations on project tfavamqszdkoeabpyxms.


-- Fix reset_user_account to also remove household membership.
-- This ensures a full reset: user goes back to SetupScreen on next login.
