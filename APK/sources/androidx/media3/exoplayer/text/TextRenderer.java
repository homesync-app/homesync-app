...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
        ...
        while (!this.inputStreamEnded) {
            try {
                ...
                if (subtitleInputBufferDequeueInputBuffer == null) {
                    subtitleInputBufferDequeueInputBuffer = ((SubtitleDecoder) Preconditions.checkNotNull(this.subtitleDecoder)).dequeueInputBuffer();
                    if (subtitleInputBufferDequeueInputBuffer == null) {
                        return;
                    } else {
                ...
                if (this.decoderReplacementState == 1) {
                    ...
                    ((SubtitleDecoder) Preconditions.checkNotNull(this.subtitleDecoder)).queueInputBuffer(subtitleInputBufferDequeueInputBuffer);
    ...
    private void initSubtitleDecoder() {
        ...
        SubtitleDecoder subtitleDecoderCreateDecoder = this.subtitleDecoderFactory.createDecoder((Format) Preconditions.checkNotNull(this.streamFormat));
