...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM600constructorimpl2;
        ...
        try {
            ...
            objM600constructorimpl = Result.m600constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM600constructorimpl = Result.m600constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m603exceptionOrNullimpl(objM600constructorimpl) == null) {
            obj2 = objM600constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM600constructorimpl2 = Result.m600constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM600constructorimpl2 = Result.m600constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m603exceptionOrNullimpl(objM600constructorimpl2) == null) {
            obj = objM600constructorimpl2;
        }
