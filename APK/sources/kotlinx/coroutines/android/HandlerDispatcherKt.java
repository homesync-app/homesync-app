...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM600constructorimpl = Result.m600constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM600constructorimpl = Result.m600constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m606isFailureimpl(objM600constructorimpl) ? null : objM600constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2178dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
