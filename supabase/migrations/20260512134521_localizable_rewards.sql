...
AS $$
  SELECT CASE public.reward_normalized_text(p_title)
    WHEN 'cafâ”œÂ® o mate preparado' THEN 'rewardTemplateCoffeeMatePrepared'
    WHEN 'cafe o mate preparado' THEN 'rewardTemplateCoffeeMatePrepared'
    WHEN 'mate o cafâ”œÂ® preparado' THEN 'rewardTemplateCoffeeMatePrepared'
    WHEN 'mate o cafe preparado' THEN 'rewardTemplateCoffeeMatePrepared'
    WHEN 'snack sorpresa' THEN 'rewardTemplateSurpriseSnack'
    WHEN 'mini nota româ”œÃ­ntica' THEN 'rewardTemplateMiniRomanticNote'
    ...
    WHEN 'helado de tu elecciâ”œâ”‚n' THEN 'rewardTemplateIceCreamChoice'
    ...
    WHEN 'maratâ”œâ”‚n de episodios a elecciâ”œâ”‚n' THEN 'rewardTemplateEpisodeMarathonChoice'
    ...
    WHEN 'vale por Ã”Ã‡Â£sâ”œÂ¡ a cualquier planÃ”Ã‡Ã˜' THEN 'rewardTemplateYesToAnyPlanVoucher'
    WHEN 'vale por "sâ”œÂ¡ a cualquier plan"' THEN 'rewardTemplateYesToAnyPlanVoucher'
    WHEN 'vale por Ã”Ã‡Â£si a cualquier planÃ”Ã‡Ã˜' THEN 'rewardTemplateYesToAnyPlanVoucher'
    WHEN 'cena afuera' THEN 'rewardTemplateDinnerOut'
    WHEN 'cita planeada completa' THEN 'rewardTemplatePlannedDate'
    WHEN 'dâ”œÂ¡a libre de tareas' THEN 'rewardTemplateChoreFreeDay'
    ...
    WHEN 'juguete o premio pequeâ”œâ–’o' THEN 'rewardTemplateSmallToyPrize'
...
AS $$
  SELECT CASE public.reward_normalized_text(p_description)
    WHEN 'una pausa rica preparada con cariâ”œâ–’o' THEN 'rewardTemplateCoffeeMatePreparedDescription'
    WHEN 'un antojo inesperado para alegrar el dâ”œÂ¡a' THEN 'rewardTemplateSurpriseSnackDescription'
    WHEN 'un mensaje corto para sonreâ”œÂ¡r' THEN 'rewardTemplateMiniRomanticNoteDescription'
    WHEN 'masaje relajante de 15 minutos' THEN 'rewardTemplateMassage15MinutesDescription'
    WHEN 'un postre frâ”œÂ¡o para celebrar' THEN 'rewardTemplateIceCreamChoiceDescription'
    WHEN 'pelâ”œÂ¡cula y ambiente especial en casa' THEN 'rewardTemplateMovieNightHomeDescription'
    ...
    WHEN 'manta, algo rico y desconexiâ”œâ”‚n' THEN 'rewardTemplateHomePicnicDescription'
    WHEN 'tiempo de charla y conexiâ”œâ”‚n' THEN 'rewardTemplateNoScreensNightDescription'
    WHEN 'vos elegâ”œÂ¡s la serie y el ritmo' THEN 'rewardTemplateEpisodeMarathonChoiceDescription'
    WHEN 'hoy te salvas de esa tarea' THEN 'rewardTemplateNoDishesVoucherDescription'
    WHEN 'vos elegâ”œÂ¡s quâ”œÂ® ver' THEN 'rewardTemplateChooseMovieVoucherDescription'
    WHEN 'tu serie, tus reglas por 7 dâ”œÂ¡as' THEN 'rewardTemplateChooseSeriesWeekVoucherDescription'
    WHEN 'vos elegâ”œÂ¡s el plan principal' THEN 'rewardTemplateWeekendPlanVoucherDescription'
    WHEN 'elegâ”œÂ¡s una tarea para delegar' THEN 'rewardTemplateSkipOneChoreVoucherDescription'
    ...
    WHEN 'cero obligaciones por todo el dâ”œÂ¡a' THEN 'rewardTemplateChoreFreeDayDescription'
...
AS $$
  SELECT CASE public.reward_normalized_text(p_category)
    ...
    WHEN 'experiencias mâ”œÃ­s grandes' THEN 'rewardCategoryExperiences'
