...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget _buildHeader() {
    ...
    final bool isAiAvatar = avatarUrl != null && avatarUrl.startsWith('http');
  ...
  Widget _buildTaskCard(dynamic task) {
    ...
    final int coins =
        (task is Map ? task['coin_reward'] : task.coinReward) ?? 0;
      ...
      children: [
        ...
        activityAsync.when(
          ...
          data: (activities) {
            ...
            return _buildActivityTimeline(activities as List<Map<String, dynamic>>);
          },
        ),
      ],
    );
  ...
  Widget _buildActivityItem(Map<String, dynamic> activity) {
    ...
    final Color activityColor =
        type == 'task' ? AppColors.primary : AppColors.sage;
    final String title = data['title'] as String? ??
        data['description'] as String? ??
        (type == 'task' ? 'Tarea' : 'Gasto');
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                          color: activityColor.withOpacity(0.3), blurRadius: 4),
                    ]),
              ),
              Expanded(
                child: Container(
