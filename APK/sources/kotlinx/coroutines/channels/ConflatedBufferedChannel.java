...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2146trySendImplMj0NB7M = conflatedBufferedChannel.m2146trySendImplMj0NB7M(e, true);
        if (objM2146trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2131exceptionOrNullimpl(objM2146trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2146trySendImplMj0NB7M = conflatedBufferedChannel.m2146trySendImplMj0NB7M(e, true);
        if (!(objM2146trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2112trySendJP2dKIU(E element) {
        return m2146trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2146trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2145trySendDropLatestMj0NB7M(element, isSendOp) : m2121trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2145trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2112trySendJP2dKIU = super.mo2112trySendJP2dKIU(element);
        if (ChannelResult.m2137isSuccessimpl(objMo2112trySendJP2dKIU) || ChannelResult.m2135isClosedimpl(objMo2112trySendJP2dKIU)) {
            return objMo2112trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2112trySendJP2dKIU = mo2112trySendJP2dKIU(element);
        if (!(objMo2112trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2112trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2131exceptionOrNullimpl(objMo2112trySendJP2dKIU);
