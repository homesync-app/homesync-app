...
public final class SilenceMediaSource extends BaseMediaSource {
    ...
    public static long getAudioByteCount(long j) {
        return ((long) Util.getPcmFrameSize(2, 2)) * Util.durationUsToSampleCount(j, SAMPLE_RATE_HZ);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static long getAudioPositionUs(long j) {
        return Util.sampleCountToDurationUs(j / ((long) Util.getPcmFrameSize(2, 2)), SAMPLE_RATE_HZ);
    }
}
