...
class _RewardsScreenState extends ConsumerState<RewardsScreen> {
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: rewardsAsync.when(
              data: (rewards) => _buildBody(rewards, currentUserId),
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                child: Opacity(
                  opacity: 0.15,
                  child: Icon(Icons.stars_rounded, size: 180, color: Colors.white),
                ),
              ),
              Positioned(
                left: -20,
              ...
              Center(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(Icons.stars_rounded, color: AppColors.accentGold, size: 36),
                    ...
                    Text(
                      'Canjeá tus coins por caricias y mimos',
                      style: TextStyle(
  ...
  Widget _buildBody(List<Map<String, dynamic>> rewards, String? currentUserId) {
    final approvedRewards = rewards.where((r) => r['is_approved'] == true).toList();
    final suggestions = rewards.where((r) => r['is_approved'] == false).toList();
  ...
  Widget _buildSuggestionsList(List<Map<String, dynamic>> suggestions, String? currentUserId) {
    return SizedBox(
      height: 180,
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isMine = s['created_by'] == currentUserId;
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: isMine ? AppColors.divider : const Color(0xFFDDD6FE).withOpacity(0.5), width: 1.5),
              boxShadow: [
                BoxShadow(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (isMine ? AppColors.primary : const Color(0xFF8B5CF6)).withOpacity(0.1),
  ...
  Widget _buildRewardsGrid(List<Map<String, dynamic>> rewards) {
  ...
  Widget _buildRewardCard(Map<String, dynamic> reward) {
    ...
    final cost = (reward['cost'] as num).toInt();
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: canAfford ? AppColors.accentGold.withOpacity(0.3) : AppColors.divider.withOpacity(0.5),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
            ...
            child: Column(
              ...
              children: [
                Stack(
                  ...
                  children: [
                    Container(
                      ...
                      height: 70,
                      decoration: BoxDecoration(
                        color: (canAfford ? AppColors.primary : AppColors.textMuted).withOpacity(0.08),
                        shape: BoxShape.circle,
                      ),
                    ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: canAfford ? AppColors.accentGold.withOpacity(0.12) : AppColors.surfaceVariant,
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
                      color: canAfford ? AppColors.accentGold.withOpacity(0.2) : Colors.transparent,
                    ),
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.stars_rounded, size: 14, color: canAfford ? AppColors.accentGold : AppColors.textMuted),
  ...
  void _confirmRedeem(Map<String, dynamic> reward, bool canAfford) {
    if (!canAfford) {
  ...
  void _showSuccessAnim(Map<String, dynamic> reward) {
