...
class _CreateTaskDialogState extends ConsumerState<CreateTaskDialog> {
  ...
  String _customRecurrenceMode =
      'weekdays'; // 'weekdays', 'interval', 'month_days'
  ...
  final List<Map<String, String>> _categories = [
    ...
    {'id': 'residuos', 'name': 'Residuos', 'icon': '🗑️'},
  ...
  Widget build(BuildContext context) {
    ...
    if (!currentCategories.any((c) => c['id'] == _selectedCategory)) {
