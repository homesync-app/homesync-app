...
public class SettingsChannel {
    ...
    public DisplayMetrics getPastDisplayMetrics(int i) {
        ConfigurationQueue.SentConfiguration configuration = this.configurationQueue.getConfiguration(i);
    ...
    static class ConfigurationQueue {
        ...
        public SentConfiguration getConfiguration(int i) {
            ...
            if (sentConfiguration2 == null) {
                Log.e(SettingsChannel.TAG, "Cannot find config with generation: " + i + ", after exhausting the queue.");
                return null;
            }
            if (sentConfiguration2.generationNumber != i) {
                Log.e(SettingsChannel.TAG, "Cannot find config with generation: " + i + ", the oldest config is now: " + this.currentConfiguration.generationNumber);
                return null;
            }
