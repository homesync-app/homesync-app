...
class _SavingsScreenState extends ConsumerState<SavingsScreen> {
  ...
  Widget build(BuildContext context) {
    ref.listen<AsyncValue<List<SavingsGoal>>>(savingsGoalsProvider, (previous, next) {
  ...
  Future<void> _handleMPContribution(SavingsGoal goal, String amountStr) async {
  ...
  void _showGoalCompletionAnim(SavingsGoal goal) {
