...
public final class NamedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2178dispatch(CoroutineContext context, Runnable block) {
        this.dispatcher.mo2178dispatch(context, block);
    }
