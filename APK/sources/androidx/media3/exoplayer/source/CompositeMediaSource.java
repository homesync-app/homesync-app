...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public abstract void m276x28f9175(T t, MediaSource mediaSource, Timeline timeline);
    ...
    protected final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        MediaSource.MediaSourceCaller mediaSourceCaller = new MediaSource.MediaSourceCaller() { // from class: androidx.media3.exoplayer.source.CompositeMediaSource$$ExternalSyntheticLambda0
            ...
            public final void onSourceInfoRefreshed(MediaSource mediaSource2, Timeline timeline) {
                this.f$0.m276x28f9175(t, mediaSource2, timeline);
            }
        };
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener, DrmSessionEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (this.mediaSourceEventDispatcher.windowIndex != windowIndexForChildWindowIndex || !Objects.equals(this.mediaSourceEventDispatcher.mediaPeriodId, mediaPeriodIdForChildMediaPeriodId)) {
            ...
            if (this.drmEventDispatcher.windowIndex == windowIndexForChildWindowIndex && Objects.equals(this.drmEventDispatcher.mediaPeriodId, mediaPeriodIdForChildMediaPeriodId)) {
                return true;
            }
