...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2179scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2100delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2101toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2101toDelayMillisLRDsOJo(long j) {
        boolean zM1984isPositiveimpl = Duration.m1984isPositiveimpl(j);
        if (zM1984isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1968getInWholeMillisecondsimpl(Duration.m1986plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1984isPositiveimpl) {
