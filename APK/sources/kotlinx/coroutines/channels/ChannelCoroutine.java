...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2119receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2119receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2120tryReceivePtdJZtk() {
        return this._channel.mo2120tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2112trySendJP2dKIU(E e) {
        return this._channel.mo2112trySendJP2dKIU(e);
    }
