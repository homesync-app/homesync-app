...
public class AndroidTouchProcessor {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent, Matrix matrix) {
        ...
        if (z) {
            ...
            for (int i3 = 0; i3 < pointerCount; i3++) {
                addPointerForIndex(motionEvent, i3, pointerChangeForAction, (pointerCount << 8) | 2, matrix, byteBufferAllocateDirect);
            }
        }
    ...
    private void addPointerForIndex(MotionEvent motionEvent, int i, int i2, int i3, Matrix matrix, ByteBuffer byteBuffer, Context context) {
        ...
        if (i7 == i4) {
            ...
            double d = horizontalScrollFactor * ((double) (-motionEvent.getAxisValue(10, i)));
            double d2 = verticalScrollFactor * ((double) (-motionEvent.getAxisValue(9, i)));
