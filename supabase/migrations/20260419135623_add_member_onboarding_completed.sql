-- Reconstructed from remote migration history (version 20260419135623).
...
-- Mark all existing members as completed
update public.household_members
  set onboarding_completed = true
  where onboarding_completed = false;

-- Change default to false for NEW members going forward
alter table public.household_members
  alter column onboarding_completed set default false;

-- Ã”Ã¶Ã‡Ã”Ã¶Ã‡ Update join_household_by_code: new joiners need onboarding Ã”Ã¶Ã‡Ã”Ã¶Ã‡
...
-- Ã”Ã¶Ã‡Ã”Ã¶Ã‡ Drop and recreate ensure_household_for_user Ã”Ã¶Ã‡Ã”Ã¶Ã‡
...
-- Ã”Ã¶Ã‡Ã”Ã¶Ã‡ New RPC: complete_member_onboarding Ã”Ã¶Ã‡Ã”Ã¶Ã‡
