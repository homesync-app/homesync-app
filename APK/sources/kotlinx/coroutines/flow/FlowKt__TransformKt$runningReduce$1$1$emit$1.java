...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningReduce$1$1", f = "Transform.kt", i = {0}, l = {WorkQueueKt.MASK, TsExtractor.TS_STREAM_TYPE_AC3}, m = "emit", n = {"this"}, s = {"L$0"})
