...
final class zzac extends zzbo<AuthResult> {
    ...
    public final Task<AuthResult> zza(String str) {
        ...
        return this.zza ? this.zzd.zzd.zzb(this.zzd.zzf, (FirebaseUser) Preconditions.checkNotNull(this.zzb), this.zzc, str, (zzcf) new FirebaseAuth.zzb(this.zzd)) : this.zzd.zzd.zza(this.zzd.zzf, this.zzc, str, (com.google.firebase.auth.internal.zzl) new FirebaseAuth.zza(this.zzd));
    }
