...
public class FlutterTextureView extends TextureView implements RenderSurface {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isContentSizingEnabled) {
            FlutterMeasureSpec.onMeasure(i, i2, new FlutterMeasureSpec.MeasureCallback() { // from class: io.flutter.embedding.android.FlutterTextureView$$ExternalSyntheticLambda0
