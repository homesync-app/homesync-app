...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        final PlaybackErrorEvent playbackErrorEventBuild = new PlaybackErrorEvent.Builder().setTimeSinceCreatedMillis(j - this.startTimeMs).setErrorCode(errorInfo.errorCode).setSubErrorCode(errorInfo.subErrorCode).setException(playbackException).build();
        this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m211xdf4bfb0e(playbackErrorEventBuild);
            }
        });
    ...
    /* synthetic */ void m211xdf4bfb0e(PlaybackErrorEvent playbackErrorEvent) {
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType != this.currentNetworkType) {
            ...
            final NetworkEvent networkEventBuild = new NetworkEvent.Builder().setNetworkType(networkType).setTimeSinceCreatedMillis(j - this.startTimeMs).build();
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m210xe45a00bc(networkEventBuild);
                }
            });
        }
    }
    ...
    /* synthetic */ void m210xe45a00bc(NetworkEvent networkEvent) {
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != iResolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            final PlaybackStateEvent playbackStateEventBuild = new PlaybackStateEvent.Builder().setState(this.currentPlaybackState).setTimeSinceCreatedMillis(j - this.startTimeMs).build();
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m212x6c41e093(playbackStateEventBuild);
                }
            });
        }
    }
    ...
    /* synthetic */ void m212x6c41e093(PlaybackStateEvent playbackStateEvent) {
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m213x86fc0269(trackChangeEventBuild);
            }
        });
    }
    ...
    /* synthetic */ void m213x86fc0269(TrackChangeEvent trackChangeEvent) {
    ...
    private void finishCurrentSession() {
        ...
        if (builder != null && this.reportedEventsForCurrentSession) {
            ...
            this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.exoplayer.analytics.MediaMetricsListener$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m209x9548dab(playbackMetricsBuild);
                }
            });
        }
    ...
    /* synthetic */ void m209x9548dab(PlaybackMetrics playbackMetrics) {
